...
use turbopack_binding::turbopack::{
    core::{
        asset::Asset, chunk::ModuleId as TurbopackModuleId, output::OutputAssetVc,
        raw_output::RawOutputVc, virtual_source::VirtualSourceVc,
    },
    ecmascript::{
...
use crate::{
    next_app::ClientReferencesChunksVc,
    next_client_reference::{ClientReferenceType, ClientReferencesVc},
};
...
impl ClientReferenceManifest {
    ...
    pub async fn build_output(
        ...
        entry_name: String,
        client_references: ClientReferencesVc,
        client_references_chunks: ClientReferencesChunksVc,
